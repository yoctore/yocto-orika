...
OrkarteSchema.prototype.get = function (name) {
  ...
  var schemas = {
    ...
    response  : {
      ...
      dtdist      : joi.date().required().format('YYYY-MM-DD').allow(null),
      ...
      dtnai       : joi.date().required().format('YYYY-MM-DD').allow(null),
      ...
      adr1        : joi.string().required().empty('').allow(null),
      adr2        : joi.string().required().empty('').allow(null),
      adr3        : joi.string().required().empty('').allow(null),
      cp          : joi.string().required().empty('').allow(null),
      ...
      dtcre       : joi.date().required().format('YYYY-MM-DD hh:mm:ss').allow(null),
      dtmod       : joi.date().required().format('YYYY-MM-DD hh:mm:ss').allow(null),
      ...
      dtsolde     : joi.date().required().format('YYYY-MM-DD hh:mm:ss').allow(null),
      enfs        : joi.array().items(
        joi.object().keys({
